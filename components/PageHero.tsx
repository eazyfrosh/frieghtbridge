  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(100%_80%_at_20%_-20%,#152FB8_0%,transparent_58%),radial-gradient(70%_60%_at_95%_0%,#2F5BFF_0%,transparent_55%)] opacity-65" />
      ...
      <div className="on-dark container">
        <Reveal>
          <nav aria-label="Breadcrumb" className="mb-7">
            <ol className="flex items-center gap-1.5 text-sm text-ink-400">
              ...
              <li className="font-medium text-ink-200" aria-current="page">
                {breadcrumb}
              </li>
            </ol>
          </nav>
        ...
        {description && (
          <Reveal delay={0.16}>
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-ink-200 sm:text-lg">{description}</p>
          </Reveal>
        )}
