...
const variants: Record<Variant, string> = {
  primary:
    'bg-brand-600 text-white shadow-[0_10px_30px_-12px_rgba(26,62,232,0.9)] hover:bg-brand-700 hover:shadow-[0_18px_40px_-14px_rgba(26,62,232,0.85)] hover:-translate-y-0.5',
  secondary:
