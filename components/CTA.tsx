        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] bg-brand-500 px-6 py-16 text-center sm:px-12 sm:py-24 lg:py-28">
            <div aria-hidden="true" className="pointer-events-none absolute inset-0">
              <div className="absolute inset-0 bg-[radial-gradient(70%_80%_at_50%_-10%,#FFA758_0%,transparent_60%),radial-gradient(50%_60%_at_85%_110%,#FF8A22_0%,transparent_60%)] opacity-55" />
              <div className="absolute inset-0 bg-grid-light bg-[size:52px_52px] opacity-30" />
              <div className="absolute -left-24 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-ink-950/[0.08] blur-[100px]" />
            </div>
            ...
            <div className="on-dark relative mx-auto max-w-2xl">
              ...
              <h2 className="display-1 mt-7 text-ink-950">
                Ready to move <span className="text-gradient">what matters?</span>
              </h2>

              <p className="mx-auto mt-6 max-w-lg text-base leading-relaxed text-ink-800 sm:text-lg">
              ...
              <p className="mt-8 text-sm text-ink-950/80">
