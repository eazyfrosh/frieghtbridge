...
const SHIPMENTS: Shipment[] = [
  ...
  },
  {
    ...
    dimensions: '53 ft dry van (full load)',
    ...
    events: [
      ...
      },
      {
        ...
        hoursAgo: 108,
        description: '18 pallets loaded and sealed at the Apapa facility.',
      },
      {
        stage: 'In Transit',
        title: 'Border clearance complete',
        location: 'Aflao Border, Ghana',
        hoursAgo: 62,
        description: 'Customs cleared in 3h 20m. Continuing to Accra.',
      },
      {
        stage: 'Out for Delivery',
        title: 'Out for delivery',
        location: 'Tema, Ghana',
        hoursAgo: 30,
        description: 'Departed the Tema yard for the consignee warehouse.',
      },
      {
        stage: 'Delivered',
        ...
        hoursAgo: 26,
        description: 'Received by K. Mensah. Proof of delivery available in your dashboard.',
      },
    ],
  },
  {
